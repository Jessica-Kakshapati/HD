pipeline {
    ...
    steps {
        ...
        bat """
            ...
            docker rm -f goof-new goof-mysql-new goof-mongo-new || echo "No containers to remove"

            REM Remove old network if it exists
            docker network rm 82cdevsecops_goof-network || echo "No network to remove"
